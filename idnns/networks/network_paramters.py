...
def get_default_parser(num_of_samples=None):
	...
	parser.add_argument('-batch_norm',
	                    '-bn', dest="batch_norm", nargs='?', type=str2bool, const=False, default=False,
	                     help='Use batch normalization')
	parser.add_argument('-l2',
	                    '-l2', dest="l2", nargs='?', type=str2bool, const=False, default=False,
	                     help='Use regularization')
	parser.add_argument('-penalty',
	                    '-pnt', dest="penalty", type=float, default=0.015,
	                     help='L2 penalty')
	...
	parser.add_argument('-activation_function',
	                    ...
	                    help='The activation function of the model 0 - thnh, 1 - RelU, 2 - softplus, 3 - ELU, 4 - PReLU, '
							 '5 -Swish, 6 - None, 10 - SReLU')
